...
@app.route('/depr', methods=['GET', 'POST'])
def depr():
    if request.method == 'POST':
        # Get form data
        ...
        if profession == 'Businessman':
            ...
            profession = 1
        elif profession == 'Service holder (Government)':
            profession= 2
        elif profession == 'Service holder (Private)':
            profession = 3
        ...
        if sleep == '5 hours':
            ...
            sleep= 3
        elif sleep == 'Below 5 hours':
            sleep= 4
        elif sleep== 'More than 8':
            sleep= 5
        else:
            sleep=0     
        insomnia = request.form['insomnia']
        if insomnia=='No':
            insomnia=0
        else:
            insomnia=1    
        ...
        data = [[profession, gender, debt, illness, threat, sleep, insomnia, anxiety, living_with,lost]]
        ...
        return render_template('depr.html')
